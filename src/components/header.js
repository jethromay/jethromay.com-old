          ...
          <div className="w-full flex-grow lg:flex lg:items-center lg:w-1/2 lg:block mt-2 lg:mt-0 hidden"
              ...
              <ul className="lg:flex flex-1 items-center lg:justify-end md:px-0 py-2">
                  ...
                  <li className="lg:mr-3 lg:ml-3 xs:py-1 sm:py-3">
                      <Link to="about.html" className="hover:underline">About</Link>
                  </li>
                  <li className="lg:mr-3 lg:ml-3 xs:py-1 sm:py-3">
                      <Link to="articles.html" className="hover:underline">Articles</Link>
                  </li>
                  <li className="lg:mr-3 lg:ml-3 xs:py-1 sm:py-3">
                      <Link to="contact.html" className="hover:underline">Contact</Link>
                  </li>
                  <li className="lg:ml-3 xs:py-1 sm:py-3">
                      <Link to='https://ko-fi.com/jethromay' target="_blank" rel="noopener noreferrer">
                          {/*<img src="img/Ko-fi.png" alt="" style="width: 35px;" />*/}
                      </Link>
                  </li>
              </ul>
          </div>
