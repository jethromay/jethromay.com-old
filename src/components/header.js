...
function Header ({ siteTitle }) {
    ...
    return (
        <header id="header"
                className="w-full bg-white lg:p-5 xs:border-2 xs:border-gray-200 sm:border-2 sm:border-gray-200 md:border-2 md:border-gray-200 lg:border-0 fixed top-0 z-50">
